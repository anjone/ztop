...
pub async fn send_confirmation_email(
    ...
    let html_body = &format!("welcome html test. <br />Click <a href=\"{}\">here</a> to confirm your subscription.",
        confirmation_link,
    );
    let text_body = &format!("welcome text test. Visit {} to confirm your subscription.",
        confirmation_link,
    );
    email_client
        .send_email(
